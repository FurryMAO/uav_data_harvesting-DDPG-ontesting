...
#
#
#             self.q_network = self.build_model(map_cast, scalars_input, states)
#             self.target_network = self.build_model(map_cast, scalars_input, states, 'target_')
#             self.hard_update()
#
...
#             stats.set_model(self.target_network)
#
#     def build_model(self, map_proc, inputs, name=''):
#
#         flatten_map = self.create_map_proc(map_proc, name)
#
#         layer = Concatenate(name=name + 'concat')([flatten_map, states_proc])
